...
public class MainFormAdmin extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        // Label nhỏ cho biết đang ở Admin (tuỳ thích)
        JLabel lbAdmin = new JLabel("ADMIN");
        lbAdmin.putClientProperty(FlatClientProperties.STYLE,
                "font:bold; foreground:#f59e0b;");
...
//        panel.add(lbAdmin);
    ...
    private JPanel createFooter() {
        ...
        JLabel lbDemoVersion = new JLabel("Admin Demo: v" + ClientDesktopApplication.DEMO_VERSION);
